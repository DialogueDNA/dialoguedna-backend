...
#             emotions: List of dicts with keys {emotion_analysis: [{label, score}, ...]}
...
#
#
#         #annotated_sentences = self.annotate_emotional_transcript(transcription, emotion_analysis)
...
#             emotions = entry.get("emotion_analysis", [])
#
...
#         :param emotions: List of {speaker, text, start_time, emotion_analysis}
...
#         :return: List of annotated sentences with emotion_analysis
#         """
#         annotated = []
#
#         for t in transcript:
...
#                 "emotion_analysis": match.get("emotion_analysis", []) if match else []
#             })
#
#         return annotated